...
for test_deb, test, val, train in data_sets:
    ...
    model = models.bilstm(word_index, embedding_filepath, INPUT_LENGTH = MAX_SENTENCE_LENGTH, EMBEDDING_DIM = 300, LSTM_OUTPUT_DIM=600, dropout=0.3)
...
for test_deb, test, val, train in data_sets:
    ...
    model = models.lstm(word_index, embedding_filepath, INPUT_LENGTH = MAX_SENTENCE_LENGTH, EMBEDDING_DIM = 300, LSTM_OUTPUT_DIM=600, dropout=0.3)
...
for test_deb, test, val, train in data_sets:
    ...
    model = models.bilstm(word_index, embedding_filepath, embedding_trainable = False, INPUT_LENGTH = MAX_SENTENCE_LENGTH, EMBEDDING_DIM = 300, LSTM_OUTPUT_DIM=600, dropout=0.3)
...
for test_deb, test, val, train in data_sets:
    ...
    model = models.lstm(word_index, embedding_filepath, embedding_trainable = False, INPUT_LENGTH = MAX_SENTENCE_LENGTH, EMBEDDING_DIM = 300, LSTM_OUTPUT_DIM=600, dropout=0.3)
