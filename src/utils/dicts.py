...
def get_stopwords():
    ...
    """
    # stopwords = %(data)s/dicts/stopwords.txt
    stopwords_file = open('data/claim-rank/dicts/stopwords.txt')
    stopwords = set()
...
def get_sentiment_lexicon():
    ...
    """
    sentiment_file = open('data/claim-rank/dicts/NRC.txt')
    emotions_lex = {}
...
def get_negative_vocab():
    negatives = set()
    negative_vocab_file = open('data/claim-rank/dicts/negative_vocab.txt')
...
def get_contra_vocab():
    contradictions = set()
    contradictions_file = open('data/claim-rank/dicts/contradictions.txt')
